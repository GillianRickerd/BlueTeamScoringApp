...
urlpatterns = [
	...
	url(r'^httpIn$', views.httpIn, name='httpIn'),
	url(r'^httpSave$', views.httpSave, name='httpSave'),
	url(r'^dnsIn$', views.dnsIn, name='dnsIn'),
	url(r'^dnsSave$', views.dnsSave, name='dnsSave'),
	url(r'^sqlIn$', views.sqlIn, name='sqlIn'),
	url(r'^sqlSave$', views.sqlSave, name='sqlSave'),
